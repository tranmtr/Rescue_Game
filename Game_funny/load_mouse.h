...
class load_Mouse
{
    public:
        ...
        void handleEvent( SDL_Event& e, Figure& Figure, SDL_Rect& arrowrightMenuRect, SDL_Rect& arrowleftMenuRect,
                         ...
                         bool& quit, int& choose, SDL_Rect& arrowdownMenuRect, bool& checkSound );
        ...
        void render(LTexture& arrowrightMenuTexture, LTexture& arrowleftMenuTexture, SDL_Rect& arrowrightMenuRect,
                    ...
                    LTexture& arrowdownMenuTexture, SDL_Rect& arrowdownMenuRect, bool& checkSound, LTexture& soundOnTexture, LTexture& soundOffTexture);
    ...
    private:
        SDL_Rect startMenu, levelMenu, howToPlay, quitMenu, nextMenu, againMenu, buttonX, backHome, soundHome;
